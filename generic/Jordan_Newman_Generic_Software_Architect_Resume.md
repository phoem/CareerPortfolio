...
Software architect and hands-on systems engineer designing production software and infrastructure across CDN, hosting, enterprise platforms, security, DevOps, and agentic AI. Architected systems operating across approximately 3,000-4,000 servers, 10 CDN locations, and more than 65 Gbps of peak traffic. Combines technical leadership with deep implementation experience, current cross-team platform direction, and end-to-end ownership from ambiguity through production.
...
- Designed Nexus as a local-first agentic control plane with model routing, MCP integrations, declarative workflows, permissions, and auditable task state.
...
- **Nexus:** Designing a local-first agentic control plane with LLM routing, MCP integrations, declarative workflows, permissioned tools, and auditable task state.
