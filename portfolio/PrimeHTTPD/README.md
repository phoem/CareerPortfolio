...
- dedicated I/O workers to handle disk operations that would otherwise block;
- `O_NONBLOCK` sockets;
...
The following information has not yet been documented and should only be added after confirmation:
...
- exact relationship between PrimeHTTPD, VirtualDir, and other CDN components at request time.
