...
title: Developer Productivity, Build, and CI Experience
description: Confirmed experience with large monorepos, remote builds, CI/CD systems, developer tooling, and package/dependency workflows.
tags: [developer-productivity, monorepo, remote-builds, github-actions, azure-pipelines, ci-cd, dependency-management]
generated:
...
# Developer Productivity, Build, and CI Experience

## Confirmed Experience

- Has worked in large monorepo environments.
- Has experience with remote builds through GitHub and Azure-hosted workflows.
- Has direct experience with GitHub Actions and Azure Pipelines.
...
Jordan's direct Nix-related exposure is limited to changes made while contributing the Azure Key Vault provider to `cachix/secretspec`, a project used in the Cachix/Nix ecosystem. This supports ecosystem familiarity through a concrete contribution, but not a claim of general Nix or NixOS expertise, large-scale Nix package-set management, or Nix-based build-infrastructure ownership.
...
- [Advantive Role](../Advantive_Role/README.md)
- [Container Runtime and Kubernetes Experience](../Container_Runtime_Experience/README.md)
- [Open Source Contributions](../Open_Source_Contributions/README.md)
- [Nexus Agentic Operating System](../Nexus_AI_Harness/README.md)
